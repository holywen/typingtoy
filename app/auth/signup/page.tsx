        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-900 dark:text-white py-3 rounded-lg font-semibold transition-colors"
            >
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/auth/signin" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 font-semibold">
              {t.common.signIn}
            </Link>
          </p>
        </div>
